  ...
  Future<Null> _selectDate(BuildContext context) async {
    ...
    if (picked != null && picked != DateTime.now())
      setState(() {
        ...
        pickedDate = picked;
        _passDataToParent('dateOfBirth', picked);
      });
            ...
            child: TextFormField(
              ...
              validator: (confirmation) {
                ...
                return confirmation.isEmpty
                    ...
                    : validationEqual(
                            confirmation, widget.passwordTextController.text)
                        ? null
                        : 'Password not match';
              },
              decoration: InputDecoration(
  ...
  void _showTermPolicy() {
    showDialog(
        ...
        child: new AlertDialog(
          title: new Text(
              "Adolescent counseling Terms of Services, Privacy Policy"),
          ...
          content: Container(
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: <Widget>[
                  Text('1. Insulting is not allowed',
                      textAlign: TextAlign.left),
                  Text('2. Do not share false informations',
                      textAlign: TextAlign.left),
                  Text('3. Advertising the use of drug is not allowed',
                      textAlign: TextAlign.left),
                  Text('4. Do not share personal informations without consent',
                      textAlign: TextAlign.left),
                ],
              ),
            ),
